package com.example.jay.mathquiz;
...
import com.example.jay.mathquiz.QuizContract.*;

import java.util.ArrayList;


public class QuizDbHelper extends SQLiteOpenHelper {
    private static final String DATABASE_NAME = "JaysQuiz.db";
    private static final int DATABASE_VERSION = 1;
    //increase this number to update the database otherwise uninstall and reinstall
